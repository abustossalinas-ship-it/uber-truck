...
**Verificación prod (jun 2026):** script [`RUN_VERIFY_ALL_MIGRATIONS.sql`](./RUN_VERIFY_ALL_MIGRATIONS.sql) → **23/23 OK**. Migración **014** (`rater_user_id`) aplicada. **Piloto C3a:** ejecutar [`RUN_033_carrier_onboarding.sql`](./RUN_033_carrier_onboarding.sql) antes de usar checklist admin.
