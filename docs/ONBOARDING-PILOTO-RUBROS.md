...
**Actualizado:** jun 2026 · **Estado:** estrategia + blueprint (implementación facial/rubros en roadmap)
...
> **Hoy en prod (jun 2026):** email + contraseña, empresa, banco, KYC manual admin. Pasos 2–5 son **roadmap C3+**; en piloto se pueden completar por WhatsApp/formulario y cargar en panel admin.
