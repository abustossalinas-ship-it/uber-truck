...
**Estado piloto:** **Cerrado (jun 2026)** — app Android en segundo plano; 3 notificaciones push de acciones de viaje recibidas en dispositivo físico. Ver [POST-MVP-CHECKLIST.md](./POST-MVP-CHECKLIST.md) ítem 5.
