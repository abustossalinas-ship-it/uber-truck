...
/** Plan piloto → escala · Cubik · 16 jun 2026 · presentación comercial */
...
/** Gantt simplificado — semanas desde 16 jun 2026 */
const GANTT_WEEKS = [
  "S1\n16–20 jun",
  "S2",
  "S3",
...
export default function CubikPlanNativeEscala() {
  ...
  return (
    <Stack gap={24} style={{ maxWidth: 960, margin: "0 auto", padding: "8px 4px 40px" }}>
      ...
      <Card>
        <CardHeader title="Gantt — 16 semanas desde 16 jun 2026" />
        <CardBody>
      ...
      <Text size="small" tone="tertiary" style={{ textAlign: "center" }}>
        Cubik · plan comercial 16 jun 2026 · infra en USD · desarrollo interno asumido en piloto
      </Text>
    </Stack>
  );
}
